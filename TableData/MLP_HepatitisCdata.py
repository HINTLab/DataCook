...
# Description: This script implements a multi-output classification MLP for HepatitisCdata.csv.
...
for epoch in range(100):
    ...
    with torch.no_grad():
        ...
        if acc > best_accuracy:
            best_accuracy = acc
            torch.save(model.state_dict(), "best_model_HepatitisCdata.pt")
...
print(classification_report(Y_test_tensor.numpy(), preds.numpy(), target_names = ['Blood Donor', 'Suspect Donor', 'Hepatitis', 'Fibrosis', 'Cirrhosis']))
