...
# Exp Setting
export config_path=configs/MedMNIST/OrganCMNIST
export dataset_type=OrganCMNIST
export poison_dataset_type=PoisonOrganCMNIST
export attack_type=Unlearnable_Cluster
